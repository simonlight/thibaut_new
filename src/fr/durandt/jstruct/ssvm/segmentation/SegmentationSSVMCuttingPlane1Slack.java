 ...
 *
 */
public class SegmentationSSVMCuttingPlane1Slack extends SSVMCuttingPlane1Slack<BagImageSeg,Integer[]> {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7600751672869976344L;
	...
	protected Integer[] lossAugmentedInference(STrainingSample<BagImageSeg, Integer[]> ts, double[] w) {
		...
		for(int l1=0; l1<nbLabels; l1++) {
			for(int l2=0; l2<nbLabels; l2++) {
				pairwise[l1 + nbLabels*l2] = 0;//-w[l1*nbLabels + l2 + offsetPairwise];
			}
		}
