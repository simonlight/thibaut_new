 ...
 *
 */
public abstract class RankingAPMantraM2CuttingPlane1Slack<X,H> extends RankingMantraM2CuttingPlane1Slack<LatentRankingInput<X, H>,List<LatentCoupleMinMax<H>>> {
