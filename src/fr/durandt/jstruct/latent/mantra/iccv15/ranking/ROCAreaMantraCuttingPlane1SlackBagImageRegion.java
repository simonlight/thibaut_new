 ...
 *
 */
public class ROCAreaMantraCuttingPlane1SlackBagImageRegion extends ROCAreaMantraCuttingPlane1Slack<BagImageRegion,Integer> {
	 ...
	 */
	@Override
	protected double[] phi(BagImageRegion x, Integer h) {
	 ...
	 */
	@Override
	protected void init(List<STrainingSample<LatentRepresentation<LatentRankingInput<BagImageRegion, Integer>, List<List<LatentCouple<Integer>>>>, RankingOutput>> l) {
