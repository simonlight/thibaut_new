...
/**
 * Abstract class for fast multi-class instantiation of MANTRA model used for CVPR 2015 submission
 * 
 ...
 * @param <H> latent
 */
public abstract class FastMulticlassMantraCVPR<X,H> implements LatentStructuralClassifier<X,Integer,H> {
