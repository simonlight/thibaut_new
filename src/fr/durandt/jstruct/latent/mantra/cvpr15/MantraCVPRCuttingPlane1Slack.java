...
/**
 * MANTRA model used for CVPR 2015 submission, optimization with (non-)convex 1 slack cutting-plane
 * 
 ...
 * @param <H> latent
 */
public abstract class MantraCVPRCuttingPlane1Slack<X,Y,H> extends MantraCVPR<X,Y,H> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5556540347996867362L;
	...
	public Object[] cuttingPlane(final List<STrainingSample<LatentRepresentation<X,H>,Y>> l, final double[] w) {
		...
		for(int i=0; i<l.size(); i++){
			...
			double[] psi2 = psi(ts.input.x, ym, hm);
			...
			double[] psi4 = psi(ts.input.x, ymi, hmi);
	...
	public String toString() {
		String s = "mantra_cuttingplane1slack_optim_" + optim + "_lambda_" + lambda + "_epsilon_" + epsilon 
