...
import fr.durandt.jstruct.latent.lssvm.LSSVMConvexCuttingPlane1Slack;
 ...
 *
 */
public abstract class LAPSVMConvexCuttingPlane1Slack<X,H> extends LSSVMConvexCuttingPlane1Slack<LatentRankingInput<X,H>,RankingOutput, List<H>> {
