 ...
 *
 */
public abstract class SegmentationLatentSSVMPegasos<X,Y,H> extends SegmentationLatentSSVM<X,Y,H> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1540911561917665565L;
	...
	public String toString() {
		String s = "segmentation_lssvm_pegasos_lambda_" + lambda + "_maxCCCPIter_" + maxCCCPIter;
		return s;
	}
