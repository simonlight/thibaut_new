 ...
 *
 */
public class FastMulticlassLSSVMCuttingPlane1SlackBagImageRegion extends FastMulticlassLSSVMCuttingPlane1Slack<BagImageRegion,Integer> {
	...
	public void copy(FastMulticlassLSSVMCuttingPlane1SlackBagImage classifier) {
		...
		this.maxCCCPIter = classifier.maxCCCPIter;
		this.minCCCPIter = classifier.minCCCPIter;
