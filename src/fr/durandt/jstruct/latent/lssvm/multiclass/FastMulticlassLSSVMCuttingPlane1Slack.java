 ...
 *
 */
public abstract class FastMulticlassLSSVMCuttingPlane1Slack<X,H> extends FastMulticlassLSSVM<X,H> {
	 ...
	 */
	protected void trainOneCCCPIteration(List<STrainingSample<LatentRepresentation<X,H>,Integer>> l) {
