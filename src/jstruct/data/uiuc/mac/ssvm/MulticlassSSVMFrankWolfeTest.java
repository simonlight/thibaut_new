...
import fr.durandt.jstruct.util.ColorTerminal;
...
public class MulticlassSSVMFrankWolfeTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(ColorTerminal.ANSI_GREEN + "lambda " + Arrays.toString(lambdaCV) + ColorTerminal.ANSI_RESET);
		...
		for(int scale : scaleCV) {
			for(int split : splitCV) {
				...
				String classifierDir = simDir + "classifier/ssvm/FrankWolfe/" + features + "/";
