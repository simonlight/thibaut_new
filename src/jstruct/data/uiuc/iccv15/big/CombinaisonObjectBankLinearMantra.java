 ...
 *
 */
public class CombinaisonObjectBankLinearMantra {
	...
	public static void main(String[] args) {
		...
		for(int split : splitCV) {
			...
			finalScoresTrain = concatenation(listScoresTrain, listTrain);
			finalScoresTest = concatenation(listScoresTest, listTest);
