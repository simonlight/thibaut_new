...
import fr.durandt.jstruct.latent.mantra.nips15.multiclass.MulticlassMantraBetaCuttingPlane1SlackBagImageRegion;
 ...
 *
 */
public class TestMulticlassMantraBetaCuttingPlane1SlackBagImageXML {
			...
			for(int split : splitCV) {
				...
				for(double epsilon : epsilonCV) {
					for(double lambda : lambdaCV) {
						...
						MulticlassMantraBetaCuttingPlane1SlackBagImageRegion classifier = new MulticlassMantraBetaCuttingPlane1SlackBagImageRegion(); 
