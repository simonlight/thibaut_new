...
import fr.durandt.jstruct.latent.mantra.iccv15.multiclass.FastMulticlassMantraCuttingPlane1SlackBagImage;
 ...
 *
 */
public class ClassifyMulticlassMantraM2CuttingPlane1SlackBagImage {
	...
	public static void main(String[] args) {
		...
		String features = "hybrid_caffe_6_relu";
		int fusion = 0;
		...
		for(int s=0; s<scaleCV.length; s++) {
			...
			for(int split : splitCV) {
				...
				String classifierDir = simDir + "/ICCV15/expes_rebuttal/classifier/MANTRA/M2/CuttingPlane1Slack/Multiclass/Fast/" + features + "/BagImageRegion/";
				...
				for(double epsilon : epsilonCV) {
					for(double lambda : lambdaCV) {
						...
						FastMulticlassMantraCuttingPlane1SlackBagImage classifier = new FastMulticlassMantraCuttingPlane1SlackBagImage(); 
