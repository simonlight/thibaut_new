...
import fr.durandt.jstruct.latent.mantra.iccv15.multiclass.MulticlassMantraPegasosBagImageRegion;
 ...
 *
 */
public class TestMulticlassMantraPegasosBagImageXML {
			...
			for(int split : splitCV) {
				...
				for(double epsilon : epsilonCV) {
					for(double lambda : lambdaCV) {
						...
						MulticlassMantraPegasosBagImageRegion classifier = new MulticlassMantraPegasosBagImageRegion(); 
