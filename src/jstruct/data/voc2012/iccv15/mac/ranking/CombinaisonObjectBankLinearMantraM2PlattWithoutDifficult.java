 ...
 * 
 */
package jstruct.data.voc2012.iccv15.mac.ranking;
...
public class CombinaisonObjectBankLinearMantraM2PlattWithoutDifficult {
	...
	public static String simDir = "/Volumes/Eclipse/LIP6/simulation/VOC2012/";
	...
	public static void main(String[] args) {
		...
		for(int split : splitCV) {
			...
			String scoreDir = simDir + "/ICCV15/scoresMaxMin/MANTRA/M2/AP/CuttingPlane1Slack/BagImageRegion/without_difficults/" + trainset + "_" + testset + "/";
			//String finalScoreDir = simDir + "/ICCV15/final_scores/MANTRA/M2/AP/CuttingPlane1Slack/BagImageRegion/without_difficults/";
			String finalScoreDir = simDir + "/results/VOC2012/Main/";
