package jstruct.data.scene15.iccv15.big;
...
public class ClassifyMulticlassMantraM2CuttingPlane1SlackBagImage {
	...
	public static String simDir = "/home/durandt/simulation/15scenes/";
	...
	public static void main(String[] args) {
		...
		for(int s=0; s<scaleCV.length; s++) {
			...
			for(int split : splitCV) {
				...
				String classifierDir = simDir + "/ICCV15/classifier/MANTRA/M2/CuttingPlane1Slack/Multiclass/Fast/" + features + "_caffe_6_relu/";
