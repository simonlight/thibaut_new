...
public class ClassifyRankingAPMantraCuttingPlane1SlackWithoutDifficultXML {
	...
	public static void main(String[] args) {
		...
		double[] lambdaCV = {Double.parseDouble(args[1])};
		//double[] epsilonCV = {1e-2, 1e-3};
		//double[] epsilonCV = {1e-3};
		double[] epsilonCV = {Double.parseDouble(args[2])};
