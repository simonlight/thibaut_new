...
public class ClassifyRankingAPMantraCuttingPlane1SlackVeryDeepWithoutDifficult {
	...
	public static void main(String[] args) {
		...
		for(int s=0; s<scaleCV.length; s++) {
			...
			for(int split : splitCV) {
				...
				String classifierDir = simDir + "/ICCV15/classifier/Mantra/M2/AP/CuttingPlane1Slack/imagenet-vgg-verydeep-19_layer_" + layer + "/BagImageRegion/without_difficults/";
